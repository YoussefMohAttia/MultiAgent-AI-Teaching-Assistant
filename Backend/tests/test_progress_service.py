...
class ResolveLevelTests(unittest.TestCase):
    def test_resolve_level_floor(self):
        ...
        self.assertEqual(rank, "Rookie")
        self.assertEqual(next_xp, 120)
    ...
    def test_resolve_level_mid(self):
        ...
        self.assertEqual(rank, "Rookie")
        self.assertEqual(next_xp, 260)
        self.assertAlmostEqual(progress, (130 - 120) / (260 - 120))
