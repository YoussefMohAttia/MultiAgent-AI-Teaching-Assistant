"""
This class is a Pydantic model that represents 
all the user information claims you can receive from
Microsoft Entra ID (Azure AD) after a successful login.
In other words, when you sign in with Microsoft and you get an ID token (a JWT)
#
"""
from typing import Optional, Union
from pydantic import Field
from Core.utils import OptStr, OptStrList, StrList
