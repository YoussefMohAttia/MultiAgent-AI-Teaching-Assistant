...
import Interactive3DScene from '@/components/ui/Interactive3DScene';
...
export function SplineSceneBasic({ onSignIn }: SplineSceneBasicProps) {
  ...
  return (
    <section className="relative w-screen min-h-screen bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black via-black/70 via-60% to-transparent z-[2]" />
