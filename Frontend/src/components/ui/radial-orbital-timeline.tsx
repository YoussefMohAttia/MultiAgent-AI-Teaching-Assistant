...
interface RadialOrbitalTimelineProps {
  ...
  onNodeSelect?: (item: TimelineItem) => void;
  openOnNodeClick?: boolean;
}
...
export default function RadialOrbitalTimeline({
  ...
  const toggleItem = (id: number) => {
    const item = timelineData.find((n) => n.id === id);
    if (openOnNodeClick && item && onNodeSelect) {
      onNodeSelect(item);
      return;
    }
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-screen flex items-center justify-center px-4">
        <div
