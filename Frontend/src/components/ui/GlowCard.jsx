...
export function GlowCard({ 
  ...
  const getInlineStyles = () => {
    const baseStyles = {
      '--base': base,
      '--spread': spread,
      '--radius': '24', // Border radius of the glow match
      '--border': '1',
  ...
  return (
    <>
      ...
      <div
        ...
        // ⚡ FIX: Removed opinionated classes so parent can control layout
        className={`relative overflow-hidden ${!customSize ? 'aspect-[3/4]' : ''} ${getSizeClasses()} ${className}`}
      >
